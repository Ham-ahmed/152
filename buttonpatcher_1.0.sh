...
echo -e "${CYAN}"
echo "################################################################"
echo "#      Start downloading and installing  buttonpatcher_1.0     #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/152/refs/heads/main/enigma2-plugin-extensions-buttonpatcher_1.0_all.ipk"
IPK_NAME="enigma2-plugin-extensions-buttonpatcher_1.0_all.ipk"
