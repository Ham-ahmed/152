...
echo -e "${CYAN}"
echo "################################################################"
echo "#  Start downloading and installing  epgimport mod_iet5 2.9    #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/152/refs/heads/main/enigma2-plugin-extensions-epgimport_mod_iet5_2.9_all.ipk"
IPK_NAME="enigma2-plugin-extensions-epgimport_mod_iet5_2.9_all.ipk"
