...
echo -e "${CYAN}"
echo "################################################################"
echo "#  Start downloading and installing oscamicamall 020 Kitte888  #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/152/refs/heads/main/enigma2-plugin-softcams-oscamicamall_020-Update-Kitte888_all.ipk"
IPK_NAME="enigma2-plugin-softcams-oscamicamall_020-Update-Kitte888_all.ipk"
