...
echo -e "${CYAN}"
echo "################################################################"
echo "#      Start downloading and installing  ipstreamer_1.00       #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/152/refs/heads/main/enigma2-plugin-extensions-ipstreamer_1.00_all.ipk"
IPK_NAME="enigma2-plugin-extensions-ipstreamer_1.00_all.ipk"
